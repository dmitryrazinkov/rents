...
public class RoomController {
    ...
    public String addRoom(@PathVariable Integer id, @ModelAttribute("room") @Valid Room room, BindingResult result, ModelMap modelMap){
        if (result.hasErrors()){
            room.setId(null);
    ...
    public String updateRoom(@PathVariable Integer id, @ModelAttribute("room") @Valid Room room, BindingResult result, ModelMap modelMap, @PathVariable Integer roomId){
        if (result.hasErrors()){
